...
if (state == playing) {
	draw_set_font(Joystix)
	draw_set_color(c_white);
	draw_sprite(spr_bars, 0, 20, surface_get_height(application_surface) - 90);
	draw_sprite(spr_bars, 0, 20, surface_get_height(application_surface) - 150);
	draw_sprite_part(spr_bars, 5, 0, 0, 60+372*obj_player.hp/obj_player.maxhp, 60, 20, surface_get_height(application_surface) - 90);
	draw_sprite_part(spr_bars, 2, 0, 0, 60+372*global.SoulCounter/32, 60, 20, surface_get_height(application_surface) - 150);
	draw_text(466, surface_get_height(application_surface) - 150, "X" + string(global.SoulCounter))
	draw_sprite(spr_bars, 4, 20, surface_get_height(application_surface) - 90);
	draw_sprite(spr_bars, 1, 20, surface_get_height(application_surface) - 150);
}
